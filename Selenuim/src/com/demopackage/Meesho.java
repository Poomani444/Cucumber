...
public class Meesho {
	...
	public static void minPriceOfProduct() {
		...
		List<WebElement> allPrice = driver.findElements(By.xpath("//div[@class='Card__BaseCard-b3n78k-0 bABJTD NewProductCardstyled__CardStyled-sc-6y2tys-0 kXDxsX NewProductCardstyled__CardStyled-sc-6y2tys-0 kXDxsX']//descendant::h5[text()='499']"));
